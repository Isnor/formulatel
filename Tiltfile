...
helm_resource("grafana", chart="oci://ghcr.io/grafana-community/helm-charts/grafana", namespace="formulatel", flags=["--values", "./kubernetes/config/grafana-values.yml", "--set-file", "dashboards.formulatel.live.json=./kubernetes/config/live_dash_v2.json"], port_forwards="3000", labels=["infra"])
