...
# helm_resource("otel-col", chart="open-telemetry/opentelemetry-collector", namespace="formulatel", flags=["--values", "./kubernetes/config/collector-values.yml"], labels=["infra"])
# helm_resource("kafka", chart="oci://registry-1.docker.io/bitnamicharts/kafka", namespace="formulatel",  flags=["--values", "./kubernetes/config/kafka-values.yml"], labels=["infra"])
# helm_resource("opensearch", chart="opensearch/opensearch", namespace="formulatel", flags=["--values", "./kubernetes/config/opensearch-values.yml"], port_forwards="9200", labels=["infra"])
# helm_resource("opensearch-dashboards", chart="opensearch/opensearch-dashboards", namespace="formulatel", flags=["--values", "./kubernetes/config/opensearch-dashboards-values.yml"], port_forwards="5601", labels=["infra"])
# helm_resource("prometheus", chart="prometheus-community/kube-prometheus-stack", namespace="formulatel", port_forwards="3000", labels=["infra"])
