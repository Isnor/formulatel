...
CREATE TABLE IF NOT EXISTS telemetry.session_lap_data (
...
ALTER TABLE telemetry.session_lap_data ADD CONSTRAINT unique_lap UNIQUE (session_id, user_id, lap_num);
